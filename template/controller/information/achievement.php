...
class ControllerInformationAchievement extends PT_Controller {
    ...
    public function index() {
        ...
        $information_info = $this->model_information_information->getInformation(45);

        foreach ($information_info as $info) {
             
            $data['breadcrumbs'][] = array(
                'text' => $info['title'],
                'href' => $this->url->link('information/achievement')
            );
        ...
        $this->response->setOutput($this->load->view('information/achievement', $data));
    }
