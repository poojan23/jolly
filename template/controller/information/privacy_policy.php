...
class ControllerInformationPrivacyPolicy extends PT_Controller {
    ...
    public function index() {
        ...
        $information_info = $this->model_information_information->getInformation(43);

        foreach ($information_info as $info) {
             
            $data['breadcrumbs'][] = array(
                'text' => $info['title'],
                'href' => $this->url->link('information/privacy_policy')
            );
