...
class ControllerInformationMemberUpdate extends PT_Controller {
    ...
    public function index() {
        ...
        $information_info = $this->model_information_information->getInformation(44);

        foreach ($information_info as $info) {
             
            $data['breadcrumbs'][] = array(
                'text' => $info['title'],
                'href' => $this->url->link('information/member_update')
            );
        ...
        $this->response->setOutput($this->load->view('information/member_update', $data));
    }
