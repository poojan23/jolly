<?php
# HTTP
define('HTTP_SERVER', 'http://localhost/jolly/launch/');
define('HTTP_CATALOG', 'http://localhost/jolly/');

# HTTPS
define('HTTPS_SERVER', 'http://localhost/jolly/launch/');
define('HTTPS_CATALOG', 'http://localhost/jolly/');

# DIR
define('DIR_ROOT', 'C:/ATDI/LMS/htdocs/jolly/');
define('DIR_APPLICATION', 'C:/ATDI/LMS/htdocs/jolly/launch/');
