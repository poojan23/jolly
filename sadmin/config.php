<?php
# HTTP
define('HTTP_SERVER', 'http://localhost/jolly/sadmin/');
define('HTTP_ADMIN', 'http://localhost/jolly/admin/');
define('HTTP_CATALOG', 'http://localhost/jolly/');

# HTTPS
define('HTTPS_SERVER', 'http://localhost/jolly/sadmin/');
define('HTTPS_ADMIN', 'http://localhost/jolly/admin/');
define('HTTPS_CATALOG', 'http://localhost/jolly/');

# DIR
define('DIR_APPLICATION', 'C:/ATDI/LMS/htdocs/jolly/sadmin/');
...
define('DIR_ADMIN', 'C:/ATDI/LMS/htdocs/jolly/admin/');
