...
class ModelVenueVenueGroup extends PT_Model
{
    ...
    public function editVenueGroup($banner_id, $data) {
    ...
    public function deleteVenueGroup($banner_id) {
        $this->db->query("DELETE FROM " . DB_PREFIX . "banner WHERE banner_id = '" . (int)$banner_id . "'");
        $this->db->query("DELETE FROM " . DB_PREFIX . "banner_image WHERE banner_id = '" . (int)$banner_id . "'");
    }

    public function getVenueGroup($banner_id) {
    ...
    public function getVenueGroups() {
        $query = $this->db->query("SELECT  * FROM " . DB_PREFIX . "venue_group WHERE status = '1'");

        return $query->rows;
    }

    public function getVenueGroupImages($banner_id) {
    ...
    public function getTotalVenueGroups() {
        $query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "banner");

        return $query->row['total'];
    }

    public function showVenueGroups() {
